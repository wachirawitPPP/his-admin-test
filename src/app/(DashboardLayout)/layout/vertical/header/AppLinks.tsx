  ...
  return (
    <>
      <div className="relative group/menu">
        ...
        >
          {AppsData.appsLink.map((item, index) => (
            <Dropdown.Item
      ...
      {/* <div className="relative group">
        <span className="h-10 w-10 hover:bg-lightprimary rounded-full flex justify-center items-center cursor-pointer group-hover:bg-lightprimary group-hover:text-primary xl:flex ">
          <Icon icon="solar:widget-3-line-duotone" height={20} />
        </span>
