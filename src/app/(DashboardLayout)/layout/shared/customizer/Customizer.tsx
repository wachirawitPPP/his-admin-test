              ...
              {themeColors.map((theme, index) => (
                <span
                  ...
                  onClick={() => {
                    ...
                    localStorage.setItem("activeTheme", theme.disp);
                  }}
                  className={`border  text-link dark:text-white border-ld py-5 px-6 rounded-md cursor-pointer ${
                    activeTheme === theme.disp ? "bg-lightprimary" : ""
                  }`}
                >
                  <Tooltip
                    content={theme.disp}
                  ...
                  >
                    <label
                      className="bg-lightprimary h-6 w-6 rounded-full block cursor-pointer flex items-center justify-center"
            ...
            <div className="flex flex-wrap  gap-4 mb-7">
              <Button
                ...
                onClick={() => {
                  ...
                  localStorage.setItem("activeLayout", "vertical");
                }}
              >
                <span className="flex items-center">
                  <Icon
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  localStorage.setItem("activeLayout", "horizontal");
                }}
