const customTheme = {
  ...
  badge: {
    ...
    icon: {
      off: "rounded-md px-2.5 py-1",
      on: "rounded-md py-[5px] px-[10px] gap-1",
      size: {
        xs: "h-3 w-3",
        sm: "h-3.5 w-3.5",
      },
  ...
  card: {
    root: {
      base: "flex rounded-md dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 relative w-full break-words",
  ...
  modal: {
    ...
    header: {
      base: "flex items-center justify-between p-4 px-6 bg-primary rounded-t-lg",
      popup: "border-b-0 p-2",
      title: "text-xl font-semibold text-white dark:text-white leading-[normal]",
      close: {
        base: "outline-none ltr:ml-auto rtl:mr-auto items-center rounded-lg bg-transparent p-1.5 text-sm text-white hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white",
        icon: "h-5 w-5",
      },
    },
    footer: {
      base: "flex  items-center gap-3 p-4 px-6",
      popup: "border-none",
    },
  },
